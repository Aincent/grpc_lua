...
#include "../../core/server/server_writer.h"

#include <cassert>

#include "../../core/server/impl/server_writer_impl.h"  // for ServerWriterImpl
...
size_t ServerWriter::GetQueueSize() const { return impl_sptr_->GetQueueSize(); }
