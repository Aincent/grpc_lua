...
-- @classmod grpc.core.client.service_stub.MethodInfo
...
function MethodInfo:new(service_name, method_name)
    local info = {
        ...
        request_type = c.get_rpc_input_name(service_name, method_name),
        response_type = c.get_rpc_output_name(service_name, method_name),
        is_client_streaming = c.is_rpc_client_streaming(service_name, method_name),
        is_server_streaming = c.is_rpc_server_streaming(service_name, method_name),
    }
